...
export const AppMessages = {
    ...
    accountTransferOwnershipAction: "소유권 양도",
    accountTransferOwnershipAccessibilityLabelSuffix: "님에게 소유권 양도",
    accountTransferOwnershipConfirmMessageSuffix:
      "님이 이 공유 가계부의 소유자가 됩니다. 나는 편집자로 남게 돼요.",
    accountTransferOwnershipConfirmTitle: "소유권을 양도할까요?",
    accountTransferOwnershipSuccess: "소유권을 양도했어요.",
    accountTransferOwnershipError: "소유권을 양도하지 못했어요.",
...
export function buildAccountTransferOwnershipConfirmMessage(displayName: string): string {
  return `${displayName}${AppMessages.accountTransferOwnershipConfirmMessageSuffix}`;
}

export function buildAccountTransferOwnershipAccessibilityLabel(displayName: string): string {
  return `${displayName}${AppMessages.accountTransferOwnershipAccessibilityLabelSuffix}`;
}
