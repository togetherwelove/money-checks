...
export const CALENDAR_DAY_CONTENT_GAP = 0;
export const CALENDAR_DAY_NUMBER_BORDER_WIDTH = 0;
export const CALENDAR_DAY_NUMBER_LINE_HEIGHT = 18;
export const CALENDAR_DAY_NUMBER_PADDING_VERTICAL = 0;
export const CALENDAR_DAY_NUMBER_WIDTH = 28;
export const CALENDAR_AMOUNT_PADDING_VERTICAL = 0;
export const CALENDAR_WEEK_DIVIDER_WIDTH = StyleSheet.hairlineWidth;
export const CALENDAR_MONTH_TRANSITION_HEADER_HEIGHT = 40;
export const CALENDAR_MONTH_TRANSITION_TITLE_FONT_SIZE = 26;
export const CALENDAR_MONTH_TRANSITION_TITLE_LINE_HEIGHT = 32;
export const CALENDAR_MONTH_SNAP_FULL_DISTANCE_DURATION_MS = 180;
export const CALENDAR_MONTH_SNAP_MIN_DURATION_MS = 24;
